      ...
      <main className="container flex items-center justify-center px-4 py-16 mx-auto">
        <Card className="w-full max-w-md border-none shadow-2xl rounded-[40px] overflow-hidden bg-card">
          <CardHeader className="p-10 pb-6 text-center space-y-2">
            ...
            <CardTitle className="text-3xl font-black font-headline text-primary tracking-tight">Welcome Back</CardTitle>
            <CardDescription className="text-lg font-medium text-muted-foreground">Sign in to continue your career journey</CardDescription>
          </CardHeader>
          <CardContent className="p-10 pt-0 space-y-6">
            ...
            <Button variant="outline" className="w-full h-14 rounded-2xl font-black flex items-center justify-center gap-3 border-2 hover:bg-muted/50 transition-all" onClick={handleGoogleLogin} disabled={isLoading}>
          ...
          <CardFooter className="p-10 pt-0 justify-center">
            <p className="text-sm text-muted-foreground font-medium">
              ...
              <Link href="/auth/signup" className="text-primary font-black hover:underline inline-flex items-center gap-1">Create an account <ArrowRight className="h-3 w-3" /></Link>
            </p>
          </CardFooter>
        </Card>
      </main>
