      ...
      <main className="container flex items-center justify-center px-4 py-20 mx-auto">
        <Card className="w-full max-w-md border-none shadow-card rounded-[32px] overflow-hidden">
          <CardHeader className="p-10 pb-6 text-center space-y-2">
            ...
            <CardDescription className="text-lg">Sign in to your CareerCompass account</CardDescription>
          </CardHeader>
          <CardContent className="p-10 pt-0 space-y-6">
            ...
            <Button variant="outline" className="w-full h-12 rounded-xl font-bold flex items-center justify-center gap-3 border-2" onClick={handleGoogleLogin} disabled={isLoading}>
