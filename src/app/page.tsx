  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <footer className="container px-4 py-12 mx-auto">
        <div className="bg-card rounded-[40px] shadow-2xl border border-border/50 p-10 md:p-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://instagram.com/saahi_sbao" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted/20 flex items-center justify-center text-foreground hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="Instagram">
                  <Instagram className="h-6 w-6" />
                </a>
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted/20 flex items-center justify-center text-foreground hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="X">
                  <Twitter className="h-6 w-6" />
                </a>
                <a href="https://wa.me/254117448455" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted/20 flex items-center justify-center text-foreground hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="WhatsApp">
