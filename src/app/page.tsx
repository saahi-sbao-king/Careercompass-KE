          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted flex items-center justify-center text-black hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="Facebook">
                  <Facebook className="h-6 w-6" />
                </a>
                <a href="https://instagram.com/saahi_sbao" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted flex items-center justify-center text-black hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="Instagram">
                  <Instagram className="h-6 w-6" />
                </a>
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted flex items-center justify-center text-black hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="X">
                  <Twitter className="h-6 w-6" />
                </a>
                <a href="https://wa.me/254117448455" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-2xl bg-muted flex items-center justify-center text-black hover:bg-primary hover:text-white transition-all hover:-translate-y-1 shadow-sm" aria-label="WhatsApp">
